...
private final Logger log = LoggerFactory.getLogger(getClass());
		...
		try {
			...
			if(paginationContentList.isEmpty()) {
				...
				for(ConfigContentModel dataInsideList : paginationContentList) 
				{
				   ...
				   String value = HtmlUtils.htmlEscape(dataInsideList.getValue());
				   ...
				   String language= dataInsideList.getLanguage();
				   ...
				   Object[] finalData={createdOn,modifiedOn,featureName,tagName,description,value,language,action};
	...
	public ResponseEntity<?> pageRendering(@RequestParam(name="type",defaultValue = "Config",required = false) String role,HttpSession session){
		...
		List<InputFields> inputTypeDateList = new ArrayList<>();
			...
			String[] dateParam= {"date","Start Date","startDate","","date","End Date","endDate","","select","Module Name","featureName","","text","Tag","parametername","50","text","Description","descriptionID","50","text","Value","valueID","50","select","Language","language",""};
