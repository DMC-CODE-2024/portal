...
public class AuditTrailModel {
   ...
   private String userAgent;
    ...
    public AuditTrailModel setNotificationSentTime(String notificationSentTime) {
    ...
    public AuditTrailModel setDeliveryTime(String deliveryTime) {
    ...
    public AuditTrailModel setDeliveryDateTime(String deliveryDateTime) {
