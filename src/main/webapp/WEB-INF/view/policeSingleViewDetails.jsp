...
<html lang="en" class="no-js">
   ...
   html, body {
    ...
    .custom-file-button, .NidFile,.firCopy,.otherdocument,.file-nameStolen,.OtherDoc{
               position: absolute;
               width: 150px;
               height: 40px;
               top: 0;
    ...
    .file-name ,.file-nameNid,.file-nameFir,.file-nameOtherDoc,.bulkFile,.file-nameNidOther{
 ...
 <div class="Status-form width-90-200" id="stolenFormBlock">
     <div class="form-content">
                 <form  onsubmit="return requestApproved()" id="stolenFormID" action="">
                 						<h4>
                 						...
                 						<div class="form-row">
                 							<div class="form-group col-md-6">
                 								<label for=""><spring:message code="stolen.IMEI1" /> <span
                 									...
                 									class="form-control bg" readonly="readonly" id="stolenIMEI1" />
                 							</div>
                 							<div class="form-group col-md-6">
                 								<label for=""><spring:message code="stolen.IMEI2" /> <span
                 									class="star"></span></label> <input  type="text"
                 									class="form-control bg" readonly="readonly" id="stolenIMEI2" />
                 							</div>
                 						...
                 						<div class="form-row">
                 							<div class="form-group col-md-6">
                 								<label for=""><spring:message code="stolen.IMEI3" /> <span
                 									class="star"></span></label> <input  type="text"
                 									class="form-control bg" readonly="readonly" id="stolenIMEI3" />
                 							</div>

                 							<div class="form-group col-md-6">
                 								<label for=""><spring:message code="stolen.IMEI4" /> <span
                 									class="star"></span></label> <input  type="text"
                 									class="form-control bg" readonly="readonly" id="stolenIMEI4" maxlength="16" />
                 							</div>
                 						</div>
					...
					<div class="form-group col-md-6">
                        ...
                        <p><small><spring:message code="stolen.invoiceType" /></small></p>
                         <div class="file-path-wrapper flexIcon">
							<input class="form-control mr-10"
								id="fileNameEdit" type="text" readonly>
                         ...
                         <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="district"  onchange="getCommune('district')">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="commune"  onchange="getPolice('commune')">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <option value=""  selected><spring:message code="select.PoliceStation" />
                                            ...
                                            <div class="form-row">
                                              ...
                                              <div class="form-group col-md-6" id="firUploadBlock" style="display:none">
                                                       ...
                                                       <input type="file" id="deviceFirCopy" onchange="isPdfAndImageValid('deviceFirCopy',1)"  class="input-file mb-1 stolenFiles" accept="image/*,.pdf">
                                                       <span id="file-nameFir" class="file-nameFir"></span>
                                                       <div class="firCopy"><spring:message code="stolen.ChooseFile" /></div>
                                                      </div>
                                                       <p><small><spring:message code="stolen.invoiceType" /></small></p>
                                              </div>
                                              <div class="form-group col-md-6" id="firDetailBlock" style="display:none">
                                                          	<label for=""><spring:message code="stolen.firCopy" /> <span class="star"></span></label>

                                                          	 <div class="file-path-wrapper flexIcon">
                                              							<input  class="form-control mr-10 "
                                              								id="fileNameEdit4" type="text" readonly>
                                              								 <a href="#" id="stolenPreviewID4" style="margin-top: 6px;">
                                              								 	<img src="./resources/assets/images/eye-icon.svg" alt="icon" class="img-fluid">
                                              								 </a>
                                              </div>
                                        </div>
                 						...
                 						<div class="form-row">
                 							...
                 							<div class="form-group col-md-12">
                 								...
                 								<input  type="textarea" class="form-control bg"
                 									id="stolenIncident">
                 							</div>
                 						</div>
                             ...
                             <select class="form-control" id="ownerNationality"  required="required" onchange="chooseNationality()">
                 						...
                 						<div class="form-row">
                 							...
                 							<div class="form-group col-md-6">
                 								...
                 								</label> <input  type="text"  class="form-control bg"
                 						...
                 						<div class="form-row">
                 							...
                 							<div class="form-group col-md-6" id="ownerPassportDiv"
                 								...
                 								<label for=""> <spring:message code="stolen.passport" />
                 									<span class="star">*</span></label> <input
                 									type="text" readonly class="form-control bg" id="stolenOwnerPassport" />
                 							</div>
                 						...
                 						<div class="form-row">
                                                               <div class="form-group col-md-6">
                                                                                           ...
                                                                                           <div id="file-input-wrapper" class="file-input-wrapper1">
                                                                                            ...
                                                                                            <p><small><spring:message code="stolen.complaintCopyType" /></small></p>
                                                                                             <div class="file-path-wrapper flexIcon">
                                                                                							<input class="form-control mr-10 " readonly
                                             ...
                                             <div class="form-row">
                                                      <div class="form-group col-md-6">
                                                          <label for=""><spring:message code="stolen.otherDocument" /> <span class="star"></span></label>
                                                                <div id="file-input-wrapper" class="file-input-wrapper1">
                                                                                               <input type="file"  class="input-file mb-1 stolenFiles" id="stolenOwnerOtherDoc" accept="image/*,.pdf">
                                                                                               <span id="file-nameNidOther" class="file-nameNidOther"></span>
                                                                                               <div class="OtherDoc"><spring:message code="stolen.ChooseFile" /></div>
                                                                                               </div>
                                                                                               <p><small><spring:message code="stolen.complaintCopyType" /></small></p>
                                                                                                <div class="file-path-wrapper flexIcon">
                                                                                   							<input class="form-control mr-10 "
                                                                                   								id="fileNameEdit3" type="text" readonly>
                                                                                   								 <a href="#" id="stolenPreviewID3" style="margin-top: 6px;">
                                                                                   								 <img src="./resources/assets/images/eye-icon.svg" alt="icon" class="img-fluid">
                                                                                   								 </a>
                                                                </div>
                                                      </div>
                 				...
                 				<div class="form-row">
                 					<div class="form-group col-md-12 mb-4">
                                        ...
                                        <textarea class="form-control" id="addRemark" rows="2" maxlength="1000"
                                        ...
                                        data-tooltip-id="892d22b4-0262-51ca-d0b3-0c5ced343cb3"></textarea>
                 								<input type="text" id="requestNo1" name="requestNo" style="display: none;"> <span class="star"
                 						...
                 						<div class="row">
                 							<div class="col-lg-12">
                 								<div class="no-border flex-end">
                 									<a href="./policeTrackLostDevice"
                 										class="btn cancel-btn"><spring:message code="OTP.back" /></a>
                                                <button type="submit"  id="submitButton"  class="btn save-button-dark"><spring:message code="OTP.verify" /></button>
                 								</div>
                 							</div>
                 						</div>
                                </form>
			...
			<div class="modal-body">
				...
				<div class="form-row">
					<div class="form-group col-md-12 center">
						<div class="form-group col-md-12 center">
							<a href="#" onclick="redirectToPolice()" class="btn save-button-dark center"
								data-dismiss="modal">Done</a>
						</div>
					</div>
				</div>
			</div>
...
<div class="modal fade" id="ViewTrackLostDeviceModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
        	...
        	<div class="form-row">
            	...
            	<p><small><spring:message code="stolen.complaintCopyType" /></small></p> --%>
            	 <div class="file-path-wrapper flexIcon">
							<input readonly="readonly" class="form-control mr-10 "
								id="fileNameEdit2" readonly="readonly" type="text">
								 <a href="#" id="stolenPreviewID2" style="margin-top: 6px;">
								 	<img src="./resources/assets/images/eye-icon.svg" alt="icon" class="img-fluid">
								 </a>
						</div>
 ...
 <!-- Priview END -->
   ...
   <script type="text/javascript"
      src="${context}/resources/project_js/policeSingleViewDetails.js?version=<%= (int) (Math.random() * 10) %>"></script>
   <script type="text/javascript"
