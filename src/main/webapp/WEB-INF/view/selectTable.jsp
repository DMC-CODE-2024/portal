...
<body data-id="39" data-roleType="${usertype}" data-userTypeID="${usertypeId}"
	...
	<%-- <section id="content">
		...
		<div class="row card-panel">
			<div class="container-fluid pageHeader">
				<p class="PageHeading"><spring:message code="sidebar.DB_Tables" /></p>
			</div>
			<div class="row">
				<div class="col s12 m12" style="margin-top: 20px;">
					<div id="submitbtn">
						<div class="input-field col s12 m1">
							<label for="Search" class="center-align ml-10"><spring:message code="sidebar.DB_Tables" /></label>
						</div>
						<div class="input-field col s7 m4">
                                <select class="browser-default" id="DBId" required onchange="setTable()" >
                                <option value="" ><spring:message code="select.DBId" /></option>
                                 </select>
                         </div>
						<div class="input-field col s7 m4">
			...
			<div class="filter-box">
				...
				<%-- <form action="" class="filter-row">
					...
					<div class="form-group">
						  <select class="form-control mb-2" id="DBId" required onchange="setTable()" >
                                <option value="" ><spring:message code="select.databaseName" /></option>
                                 </select>
					</div>
					
					<div class="form-group">
						<select class="form-control browser-default" id="tableId" required="">
							<option value="" ><spring:message code="select.table" /></option>
							 </select>
					</div>
					<button type="button" class="btn btn-primary"  id="submit" onclick="hide();"><spring:message code="button.submit" /></button>
				</form> --%>
                        ...
                        <form>
							...
							<option value="" >Select</option>
                              ...
                              <div class="col-auto">
                               <button type="button" class="btn save-button"  id="submit" onclick="hide();"><spring:message code="button.submit" /></button>
                              </div>
                            </div>
                          </form>
...
<script type="text/javascript" src="${context}/resources/plugins/materialize.js"></script>
	...
	<script type="text/javascript" src="${context}/resources/project_js/selectTable.js?version=<%= (int) (Math.random() * 10) %>"></script>
