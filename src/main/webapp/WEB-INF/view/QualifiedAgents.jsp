...
<html lang="en" class="no-js">
            ...
            <div class="content-container" id="datatableViewDiv">
               ...
               <div class="filter-box" id="filterBox">
                  <form action="" class="filter-row" id="filterform">
                      <div id="errorMsgDiv" class="filter-form-row" style="width: 100%;">
                      </div>
                  ...
                  <div id="messageTableDiv" class="filter-form-row" style="width: 100%;"></div>
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
               ...
               <div class="modal-header">
                  <h5 class="modal-title" id="">Upload QA File</h5><br>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true" onclick="ResetModel()" class="cross">&times;</span>
                  </button>
               </div>
                <form action="#" onsubmit="return uploadFile()" method="POST"  id="uploadTAForm">
               <div class="modal-body prl-30">
                  <div class="form-row">
                     <div class="form-group col-md-12">
                        <label for="">Upload QA File <span class="star">*</span></label>
                        <input type="file"  accept=".txt" class="input-file" id="fileInput" oninvalid="InvalidMsg(this,'fileType','<spring:message code="validation.NoChosen" />');" onchange="validateFile(this,'TXT_ALLOWED');" required>
                        <p><spring:message code="filetype.message" /></p>
                        <p><a id="sampleFileDownloadId83" href="#" onclick=" if(typeof sampleFileDownloadById === 'function')  sampleFileDownloadById('83','sample_qa')" ><img src="${context}/resources/assets/images/download-icon-blue.svg" alt="icon" title="TA file" class="img-fluid"> Download Sample File </a></p>
                     </div>
                  </div>
                  <div class="form-row">
   ...
   <script type="text/javascript"
      src="${context}/resources/project_js/qualifiedAgent.js?version=<%= (int) (Math.random() * 10) %>"></script>
   <script type="text/javascript"
