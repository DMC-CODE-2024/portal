...
<html lang="en" class="no-js">
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
               ...
               <div class="modal-header">
                  <h5 class="modal-title" id="">Upload Local Manufacture File</h5>
               ...
               <div class="modal-body prl-30">
                  <div class="form-row">
                     <div class="form-group col-md-12">
                        <label for="">Upload Local Manufacture File <span class="star">*</span></label>
                        ...
                        <p><a id="sampleFileDownloadId85" href="#" onclick=" if(typeof sampleFileDownloadById === 'function') sampleFileDownloadById('85','sample_lm')" ><img src="${context}/resources/assets/images/download-icon-blue.svg" alt="icon" title="TA file" class="img-fluid"> Download Sample File </a></p>
                     </div>
                  </div>
                  <div class="form-row">
   ...
   <script type="text/javascript"
      src="${context}/resources/project_js/localManufacture.js?version=<%= (int) (Math.random() * 10) %>"></script>
   <script type="text/javascript"
