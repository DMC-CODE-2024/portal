...
<c:if test="${pageContext.response.locale=='km'}">
    ...
    <h1><spring:message code="tag.pair-device.pairDevice" /></h1>
    </div>
    <div class="width-90 mt-35" id="pairDeviceFormDiv">

    <div class="form-content">
    <form id="pairDeviceForm">
    <div id="imeiContainer">
    <div class="form-row imei-row">
    <div class="form-group col-md-5">
    <label for="imei1"><spring:message code="stolen.IMEI1" /><span class="star">*</span></label>
    <input type="text" autocomplete="off" class="form-control imei" id="imei1" name="imei1" placeholder="<spring:message code="placeholder.pair-device.15digitimei" />"
    ...
    <div class="form-group col-md-5">
    <label for="phoneNumber1"><spring:message code="tag.pair-device.phoneNumber" /><span class="star">*</span></label>
    ...
    oninvalid="InvalidMsg(this,'input','<spring:message code="validation.msisdn.10digit.0855" />');" required>
    </div>
    <div class="form-group col-md-2">
    <button type="button" class="btn Back-button mt-28 addImei">+ <spring:message code="tag.pair-device.addIMEI" /></button>
    </div>
    </div>
    </div>
    ...
    <div class="form-row">
    <div class="form-group col-md-5">
    <label for="serialNumber"><spring:message code="tag.pair-device.serialNumber" /> <span class="star">*</span></label>
    <input type="text" autocomplete="off" class="form-control" id="serialNumber" name="serialNumber" placeholder="<spring:message code="placeholder.pair-device.serialnumber" />"
     oninput="InvalidMsg(this,'input','');"
         oninvalid="InvalidMsg(this,'input','');"required>
    </div>
    </div>
    <label for="emailAddress"><spring:message code="tag.pair-device.otp" /> <span class="star">*</span></label>
...
<span id="errorMsgOnModal"  class="text-danger" style="display: none" ><spring:message code="bulk.invalidCaptcha" /></span>
    ...
    <button id="pairDeviceSubmitBtn" type="submit" class="orange-button btn" style="margin-left: 10px;"><spring:message code="tag.pair-device.submit" /></button>
    </div>
    </div>
    </div>
    </form>
    ...
    <div class="width-90 mt-20 center width-100" id="pairDeviceOTPForm" style="display:none">

    <h1 class="mb-10"><spring:message code="tag.pair-device.validateOTP" /></h1>
    <p><spring:message code="tag.pair-device.verifysent" /></p>
           <!--
        <span id="countryCode"></span> <span id="phoneNumberOTP"></span> /
        <spring:message code="tag.pair-device.emailAddress" /> <span id="emailMasking"></span></p>
    -->
    ...
    <button onclick="return submitOTPRequest(event,'pair')" class="btn orange-button"><spring:message code="tag.pair-device.verify" /></button>
    </div>
    </div>
    </div>
    ...
    <h1><spring:message code="tag.pair-device.requestUnsuccessful" /></h1>
    <p><spring:message code="tag.pair-device.request" /> <span id="rejectrequestNumberSpan"></span>  <spring:message code="tag.pair-device.failed.requestNumber" /></p>
  <%--   <p><spring:message code="tag.pair-device.confirmationMsg" /></p> --%>

    <div class="row">
         <div class="table-box TableBorder">
                    <table class="table align-left display" id="invalidpairdatatable">
    ...
    <div class="col-lg-12 mt-20">
    <div class="no-border center">
    <a href="${context}/pair-device" type="button" class="btn orange-button width50-btn"><spring:message code="tag.pair-device.done" /></a>
    </div>
    </div>
    </div> </div>
    ...
    <div class="width-90 mt-20 center  width-100"  id="acceptedMsgModal" style="display:none">
    <p class="mb-10"><img src="${context}/resources/assets/images/CheckIcon.svg" alt="logo" class="img-fluid"></p>
    <h1><spring:message code="tag.pair-device.accepted" /> </h1>
    <p><spring:message code="tag.pair-device.request" /> <span id="requestNumberSpan"></span>  <spring:message code="tag.pair-device.requestNumber" /></p>
    <p><spring:message code="tag.pair-device.confirmationMsg" /></p>
    <div class="row">

               <div class="table-box TableBorder">
                <table class="table align-left display" id="validpairdatatable">
                <thead class="thead-dark">
                <tr>
                <th>S.No</th>
                <th>IMEI</th>
    ...
    <div class="no-border center">
    <a href="${context}/pair-device" type="button" class="btn orange-button width50-btn"><spring:message code="tag.pair-device.done" /></a></div>
    </div>
    </div>
    </div>
</div>
...
<div class="width-90 mt-20 center width-100" id="otpLimitExceedModal" style="display:none">
    ...
    <div class="col-lg-12 mt-20">
    <div class="no-border center">
    <a href="${context}/pair-device" type="button" class="btn orange-button width50-btn"><spring:message code="tag.button.cancel" /></a>
    </div>
    </div>
    </div> </div>
    ...
    <script type="text/javascript"
    src="${context}/resources/project_js/pair-device.js?version=<%= (int) (Math.random() * 10) %>"></script>
