...
<body data-id="31"
							...
							<div class="form-row">
							  ...
							  <div class="form-row">
								<div class="form-group col-md-12">
									<label for="description" class=""><spring:message code="registration.description" />
	...
	<div id="viewAlertModal" class="modal" tabindex="-1" role="dialog">
				<div class="modal-dialog modal-lg" role="document">
				  <div class="modal-content">
					<div class="modal-header">
					  <h5 class="modal-title"><spring:message code="modal.header.viewAlert" /></h5>
					</div>
					<div class="modal-body">
							<div class="form-row">
							  <div class="form-group col-md-6">
								<label for="viewAlertId"><spring:message code="table.alertId" /></label>
								<input type="text" name="period" class="form-control" id="viewAlertId" placeholder="Period" disabled>
							  </div>
							  <div class="form-group col-md-6">
								<label for="viewfeature"><spring:message code="table.moduleName" /> </label>
								<input type="text" id="viewfeature" class="form-control" name="feature" placeholder="" maxlength="20" placeholder="Status" disabled>
							  </div>
							</div>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-12">
									...
									<textarea id="viewdescription" class="form-control" placeholder="Description" title="Please enter alphabets and numbers upto 200 characters only" maxlength="200" disabled></textarea>
								</div>
							  </div>
					    </div>
					    <div class="modal-footer">
                        						<button class="cancel-product btn modal-close" type="submit"><spring:message code="modal.close" /></button>
                        					</div>
				</div>
			  </div>
			  </div>
