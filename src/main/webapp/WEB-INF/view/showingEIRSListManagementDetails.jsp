...
<div class="modal fade" id="NewRequest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <input type="" class="form-control" id="form1-imei" pattern="<spring:eval expression="@environment.getProperty('pattern.ImeiAplhanumericLength16')" />" minlength="1" maxlength="16" oninput="InvalidMsg(this,'input','<spring:message code="validation.imeialphanumeric.16digit" />');"
                                         oninvalid="InvalidMsg(this,'input','<spring:message code="validation.imeialphanumeric.16digit" />');" placeholder="Enter 1 to 16 AlphaNumeric IMEI Number" >
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="RequestForm">
                                    <form id="form2" action="" onsubmit="return bulkRequest()">
                                          <div class="form-group row">
                                            <label for="inputPassword3" class="col-sm-3 col-form-label">Category <span class="star">*</span></label>
                                            <div class="col-sm-9">
                                                <select class="form-control" id="form2-type" required> <option value='' selected>Select</option></select>
                                          ...
                                          <div class="form-group row">
                                            <label for="inputPassword3" class="col-sm-3 col-form-label">Request Type <span class="star">*</span></label>
                                            <div class="col-sm-9">
                                                <select class="form-control" id="form2-action" required><option value='' selected>Select</option></select>
                                          ...
                                          <div class="form-group row">
                                            <div class="col-sm-12">
                                                <input type="file" accept=".csv" class="input-file mb-1"  id="fileInput" oninvalid="InvalidMsg(this,'fileType','<spring:message code="validation.NoChosen" />');"
                                                onchange="validateFile(this,'CSV_ALLOWED');" required>
                                                <p><a href="#" onclick=" if(typeof sampleFileDownloadById === 'function')  sampleFileDownloadById('86','sample_el','csv')"><img src="${context}/resources/assets/images/download-icon-blue.svg" alt="icon" title="TA file" class="img-fluid"><small> Download Sample File </small></a></p>
 ...
 <div class="modal fade" id="ViewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">View Exception List</h5>
        </div>
...
<!--materialize js-->
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/list-management.js?version=<%= (int) (Math.random() * 10) %>"></script>
	<script type="text/javascript"
