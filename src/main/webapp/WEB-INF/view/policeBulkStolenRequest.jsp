                   ...
                   <h4><spring:message code="stolen.heading2" /></h4>
                     ...
                     <div class="form-group col-md-6">
                         <label for=""><spring:message code="stolen.BulkFile" /> <span class="star">*</span></label>
                           <div id="file-input-wrapper4" class="file-input-wrapper4">
                            <input type="file" id="stolenMobileFile" onchange="isPdfAndImageValid('stolenMobileFile',1)" required class="input-file mb-1 stolenFiles" accept=".csv">
                            <span id="bulkFile" class="bulkFile"></span>
                             <div class="file-nameStolen"><spring:message code="stolen.ChooseFile" /></div>
                            </div>
                            <a href="#" onclick=" if(typeof sampleFileDownloadById === 'function')  sampleFileDownloadByIdBulk('sample_st','csv')"><img src="${context}/resources/assets/images/download-icon-blue.svg" alt="icon" title="TA file" class="img-fluid"><small> Download Sample File </small></a></p>
                      </div>
                     <div class="form-group col-md-6">
             ...
             <div class="form-row">
               <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control" id="stolenRemark" rows="2"
                                        placeholder="<spring:message code="placeholder.incident" />" required="" title=" "
...
<div class="modal fade" id="ViewTrackLostDeviceModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <!-- Priview END -->
   ...
   <script type="text/javascript"
      src="${context}/resources/project_js/policeBulkStolenRequest.js?version=<%= (int) (Math.random() * 10) %>"></script>
   <script type="text/javascript"
