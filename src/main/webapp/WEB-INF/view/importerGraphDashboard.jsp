				...
				<div class="section">
					<div class="row">
						<div class="col s12 m12 l12">
                            ...
                            <spring:message code="sidebar.Importer_Dashboard" />
                            				</h6>
                            				<div id="wrapperPage">
                     ...
                     <div class="split">
                            	 				<h6 class="m-0 font-weight-bold text-primary" id="monthdateVal"></h6>
                            						<div class="col s12 m12 info-div center" id="infoBox1">
...
<script type="text/javascript"
		src="${context}/resources/graph_js/importerGraphDashboard.js?version=<%= (int) (Math.random() * 10) %>"></script>		
