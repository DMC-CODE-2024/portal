			  ...
			  <div class="modal-content">
				...
				<div class="modal-content_">
					<form id="form2" >
                        ...
                        <label for="">Operator Name <span class="red">*</span></label>
                       <select id="form2-operatorName" class="form-control" required>
                        <option value='' selected>Select</option>
                       </select>
                       </div>

                        <div class="form-group col-md-6">
                        <label for="">Series Type <span class="red">*</span> </label>
                        <select id="form2-seriesType" class="form-control" required>
                         <option value='' selected>Select</option>
                          </select>
                      </div>
								</div>
						...
						<div class="form-row">
                       <div class="form-group col-md-6">
                     <label for="">Series Start <span class="red">*</span></label>
                     <input type="text" class="form-control" id="form2-seriesStart" name="start" minlength="5" maxlength="5" pattern="" oninput=""
                      oninvalid="" placeholder="Enter" required>
                       <span id="errorDivForm2" class=""></span>
                   </div>
                   <div class="form-group col-md-6">
                 <label for="">Series End <span class="red">*</span></label>
                 <input type="text" class="form-control" id="form2-seriesEnd" name="end" minlength="5" maxlength="5" pattern="" oninput=""
                  oninvalid="" placeholder="Enter" required>
               </div>
  </div>
  <div class="form-row">
  						<div class="form-group col-md-6">
                          <label for="">Length <span class="red">*</span></label>
                         <select id="form2-length" class="form-control" required>
                         <option value='' selected>Select</option>
                         </select>
                         </div></div>
				<div class="form-row">
                <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control" rows="3" id="form2-remarks" placeholder="Write remarks here..."></textarea>
                </div>
                </div>
                </div>

				<div class="modal-footer">
					<button class="save-product btn" onclick="updateSeries(event)" style="margin-left: 10px;"><spring:message code="button.update" /></button>
	...
	<div id="addModal" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				...
				<div class="modal-content_">
					<form action="#"  id="form1" onsubmit="event.preventDefault();addSeries()">
						<div class="modal-body">
						<div class="form-row">
						<div class="form-group col-md-6">
                        <label for="">Operator Name <span class="red">*</span></label>
                       <select id="form1-operatorName" class="form-control" required>
                       <option value='' selected>Select</option>
                       </select>
                       </div>
                        ...
                        <div class="form-group col-md-6">
                        <label for="">Series Type <span class="red">*</span></label>
                        <select id="form1-seriesType" class="form-control" required>
                            <option value='' selected>Select</option>
                          </select>
                      </div>
								</div>
                       ...
                       <div class="form-group col-md-6">
                     <label for="">Series Start <span class="red">*</span></label>
                     <input type="text" class="form-control" id="form1-seriesStart" minlength="5" maxlength="5"  pattern="" oninput=""
                     oninvalid="" required placeholder="Enter">
                   <span id="errorDiv" class=""></span>
                   </div>
                   <div class="form-group col-md-6">
                 <label for="">Series End <span class="red">*</span></label>
                 <input type="text" class="form-control" id="form1-seriesEnd" minlength="5" maxlength="5" pattern="" oninput=""
                 oninvalid="" required placeholder="Enter">
                </div>
                </div>
                <div class="form-row">
						<div class="form-group col-md-6">
                        <label for="">Length <span class="red">*</span></label>
                       <select id="form1-length" class="form-control" required>
                       <option value='' selected>Select</option>
                       </select>
                       </div></div>
                ...
                <div class="form-group col-md-12">
                  <label for="">Remarks</label>
                  <textarea class="form-control" rows="3" id="form1-remarks" placeholder="Write remarks here..."></textarea>
                </div>
                </div>
                </div>

				<div class="modal-footer">
					<button class="save-product btn" type="submit" style="margin-left: 10px;"><spring:message code="button.submit" /></button>
					<button class="cancel-product btn modal-close" type="button" style="margin-left: 10px;"><spring:message code="button.cancel" /></button>
				</div>
			</form>
			  </div>
...
<div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">Delete Series</h5>
	...
	<div id="updateFieldsSuccess" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				...
				<div class="modal-footer">
					<a href="${context}/msisdn-series-view" class="cancel-product btn modal-close"><spring:message code="modal.ok" /></a>
				</div>
			  </div>
			</div>
		  </div>
...
<%-- 	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/msisdn-series.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
