	...
	<section id="content">
		...
		<div class="row card-panel">
			...
			<div class="row">
				...
				<form action="uploadPaidStatus" method="GET" 
					...
					<div id="submitbtn">
						...
						<div class="input-field col s12 m3 l3">
							<input type="text" id="Search" name="NID"
								 pattern="<spring:eval expression="@environment.getProperty('pattern.operatorNid')" />" maxlength="13"
								...
								<input type="text" name="via" value="other"  style="display:none">
								
						</div>
						<div class="input-field col s12 m2 l2">
							<button type="submit" class="btn"  id="submit" onclick="hide()"><spring:message code="button.submit" /></button>
