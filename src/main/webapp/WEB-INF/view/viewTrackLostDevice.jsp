        ...
        <div class="modal-body">
              ...
              <h4><spring:message code="stolen.heading2" /></h4>
                <div class="form-row">
                   <div class="form-group col-md-6">
                        ...
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenMobile1" />
									<input type="text" class="form-control bg" id="stolenMgmtid"  style="display: none">
									<input type="text" class="form-control bg" id="stolenMgmtRequestid"  style="display: none">			 
                        </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for=""><spring:message code="stolen.IMEI1" /> <span class="star">*</span></label>
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenIMEI1" />
			   		</div>
			   		 <div class="form-group col-md-6">
                        <label for=""><spring:message code="stolen.IMEI2" /> <span class="star"></span></label>
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenIMEI2" />
			   		</div>
                 ...
                 <div class="form-row">
                  <div class="form-group col-md-6">
                      ...
                      <input readonly="readonly" type="text" class="form-control bg" id="stolenIMEI3"  />
                    </div>

                     <div class="form-group col-md-6">
                      <label for=""><spring:message code="stolen.IMEI4" /> <span class="star"></span></label>
                      <input readonly="readonly" type="text" class="form-control bg" id="stolenIMEI4"   maxlength="16"/>
                    </div>
              </div>
                 
              <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for=""><spring:message code="stolen.db.Device_brand" /> <span class="star">*</span></label>
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenDeviceBrand" required >
                      </div>

                       <div class="form-group col-md-6">
                        <label for=""><spring:message code="stolen.db.Device_model" /> <span class="star">*</span></label>
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenDeviceModel" required >
                      </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenDeviceType" required >
                      </div>

                       <div class="form-group col-md-6">
                        <label for=""><spring:message code="stolen.serialNumber" /></label>
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenSerialNumber"  >
                      </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input readonly="readonly" type="date"  id="stolenDate" class="form-control text-uppercase bg" required >
                      </div>
                     
                      <div class="form-group col-md-6">
                        <label for=""><spring:message code="stolen.time" /> <span class="star">*</span></label>
                        <input readonly="readonly" type="time" id="stolenTime" class="form-control text-uppercase bg" required >
                      </div>
				</div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <!-- <select class="form-control" id="provinceCity" onchange="getDistrict('provinceCity')" required="required">
                      	 ...
                      	 <input readonly="readonly" type="text" class="form-control bg" id="provinceCity"  >
                      </div>
                    ...
                    <div class="form-group col-md-6">
                       ...
                       <!--  <select class="form-control" id="district" required="required" onchange="getCommune('district')">
                      		 ...
                      		 <input readonly="readonly" type="text" class="form-control bg" id="district"  >
                      </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                       ...
                       <input readonly="readonly" type="text" class="form-control bg" id="commune"  >
                      </div>
                      <div class="form-group col-md-6">
                        ...
                        <input readonly="readonly" type="text" class="form-control bg" id="policeStation"  >
                      </div>
                  </div>
                 ...
                 <div class="form-row">
                     ...
                     <div class="form-group col-md-6">
                        <label for=""><spring:message code="lost.category" /> <span class="star">*</span></label>
                      	 <input readonly="readonly" type="text" class="form-control bg" id="category"  >
                      </div>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input readonly="readonly" type="text" class="form-control bg" id="stolenIncident"  >
                      </div>
                  </div>
                ...
                <div class="form-row">
                   	<div class="form-group col-md-6">
                        <label for=""><spring:message code="lost.Nationality" /> <span class="star">*</span></label>
                      		<input readonly="readonly" type="text" class="form-control bg" id="ownerNationality"  >
                      </div>
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                      ...
                      <input readonly="readonly" type="text" required class="form-control bg" id="stolenOwner" />
                    </div>

                    <div class="form-group col-md-6" id="ownerEmailDiv" >
                      <label for=""><spring:message code="stolen.email" /> <span class="star">*</span></label>
                      <input readonly="readonly" type="text" class="form-control bg" id="stolenEmail" required />
                    </div>
                    ...
                    <div class="form-group col-md-6" id="ownerDOBlDiv" style="display: none">
                        ...
                        <input readonly="readonly" type="date"  id="ownerDOB" class="form-control bg text-uppercase" >
                      </div>
			...
			<div class="form-row">
			 <div class="form-group col-md-6">
                      ...
                      <input readonly="readonly" type="text" required class="form-control bg" id="stolenOwnerAddress1" />
                    </div>
                    
                <div class="form-group col-md-6">
                    <label for=""><spring:message code="stolen.Address2" />  </label>
                    <input readonly="readonly" type="text" class="form-control bg" id="stolenOwnerAddress2" />
                  </div>
			</div>
			<div class="form-row">
                <div class="form-group col-md-6" id="ownerNIDdiv">
                  <label for=""> <spring:message code="stolen.nid" />  <span class="star">*</span></label>
                  <input readonly="readonly" type="text"  required class="form-control bg" id="stolenOwnerNID" />
             </div>
                ...
                <div class="form-group col-md-6" id="ownerPassportDiv" style="display:none">
                  ...
                  <input readonly="readonly" type="text"  class="form-control bg" id="stolenOwnerPassport" />
                </div>

                <div class="form-group col-md-6" id="otpContactDiv">
                  <label for=""><spring:message code="stolen.OTPContact" /> <span class="star">*</span></label>
                  <input readonly="readonly" type="text" required class="form-control bg" id="stolenOwnerOTPContact" />
                </div>
                ...
                <div class="form-group col-md-6" id="otpEmailDiv" style="display:none">
                      ...
                      <input readonly="readonly" type="text" class="form-control bg" id="stolenOtpEmail"/>
                    </div>
          	</div>
        	<div class="form-row">
          		<div class="form-group col-md-6">
...
<!-- Modal Bulk View close-->
 ...
 <!-- Priview END -->
  <!--materialize js-->
   ...
   <script type="text/javascript"
      src="${context}/resources/project_js/viewTrackLostDevice.js?version=<%= (int) (Math.random() * 10) %>"></script>
   <script type="text/javascript"
