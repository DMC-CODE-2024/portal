...
<div id="viewAdminSystemModel" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title"><spring:message code="modal.Configuration" /></h5>
				</div>
				<div class="modal-content_">
						...
						<div class="form-row">
								...
								<input type="text" id="viewValue" class="form-control" placeholder="Value" readonly="readonly">
								</div>
					...
					<div class="form-group col-md-6">
                			...
                			<input type="text" id="viewModifiedBy" class="form-control" disabled>
								...
								<div class="form-group col-md-6">
									<label for="viewtype"><spring:message code="table.Type" /></label>
									<input type="text" id="viewtype" class="form-control" name="type" placeholder="Type" maxlength="20" disabled>
								</div>
								...
								<div class="form-group col-md-12">
									<label for="remarks" class=""><spring:message code="systemmanagement.input.remarks" /></label>
								<textarea id="remarks" placeholder="Remarks" class="materialize-textarea form-control" style="min-height:8rem" maxlength="200" readonly="readonly"></textarea>
	...
	<div id="editAdminSystemModel" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title"><spring:message code="modal.EditConfiguration" /></h5>
				</div>
				<div class="modal-content_">
					<form action="" onsubmit="return updateSystem()">
						...
						<div class="form-row">
								...
								<input type="text" id="editValue" class="form-control" maxlength="100" required="required">
								</div>
					...
					<div class="form-group col-md-6">
                			...
                			<input type="text" id="editModifiedBy" class="form-control" disabled>
								...
								<select id="editfeatureName" name="editfeatureName"
                                                                    							class="form-control" class="mySelect"
                                                                    							onchange="InvalidMsg(this,'select','<spring:message code="validation.selectFieldMsg" />');" oninvalid="InvalidMsg(this,'select','<spring:message code="validation.selectFieldMsg" />');"
                                                                    							required disabled></select>
						<!--	<input type="text" id="editfeatureName" class="form-control" name="feature" placeholder="" maxlength="20" placeholder="Module Name" disabled> -->
								...
								<div class="form-group col-md-12">
									<label for="editremarks" class=""><spring:message code="systemmanagement.input.remarks" /></label>
	...
	<div id="confirmedUpdatedSystem" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title"><spring:message code="modal.UpdateSystem" /></h5>
				</div>
				<div class="modal-body">
