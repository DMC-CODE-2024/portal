    ...
    <h5 class="modal-header"><spring:message code="modal.notification.title" /></h5>
    <div class="modal-body">
    <div class="form-row" >
    <table class="forEmail" id="forEmail" style="display:none">
    <tbody>
    <tr>
    <th>Email ID :</th>
    <td id="emailId"></td>
    ...
    <table class="forMSISDN" id="forMSISDN" style="display:none">
    <tbody>
    <tr>
    <th>MSISDN :</th>
    <td id="msisdnval"></td>
    ...
    <script type="text/javascript"
    <script type="text/javascript"
    src="${context}/resources/project_js/notification.js?version=<%= (int) (Math.random() * 10) %>"></script>
    <script type="text/javascript"
