...
<body data-roleType="${usertype}" data-userTypeID="${usertypeId}" data-userID="${userid}" data-selected-roleType="${selectedUserTypeId}" 
                    ...
                    <div class="filter-box">
                        <form action="" class="filter-row" id="viewFilter">
                        	<div id="errorMsgDiv" class="filter-form-row" style="width: 100%;"></div>
       						<div id="blockedTACTableDiv" class="filter-form-row"></div>
       						<div id="blockedTACTableButtonDiv" class="filter-btn-row"></div>
                        </form>
                    </div>
                    <div class="table-box">
	...
	<div id="viewBlockedTACModel" class="modal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg" role="document">
		  <div class="modal-content">
				<h5 class="modal-header"><spring:message code="modal.blockedTac" /></h5>
	...
	<div id="editBlockedTACModel" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/viewBlockedTAC.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
