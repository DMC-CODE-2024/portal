...
<body data-roleType="${usertype}" data-userTypeID="${usertypeId}" data-userID="${userid}" data-selected-roleType="${selectedUserTypeId}" 
                    ...
                    <div class="filter-box">
                        <form action="" class="filter-row" id="viewFilter">
                        	<div id="errorMsgDiv" class="filter-form-row"></div>
       						<div id="allowedTACTableDiv" class="filter-form-row"></div>
       						<div id="allowedTACTableButtonDiv" class="filter-btn-row"></div>
                        </form>
                    </div>
                    <div class="table-box">
	...
	<div id="viewAllowedTACModel" class="modal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg" role="document">
		  <div class="modal-content">
				<h5 class="modal-header"><spring:message code="modal.allowedTac" /></h5>
			<div class="modal-body">
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						<label for="viewModifiedBy" class="center-align"><spring:message code="table.tag" /></label>
						<input type="text" id="viewTac" class="form-control" disabled>
					</div>
	...
	<div id="editAllowedTACModel" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/viewsAllowedTAC.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
