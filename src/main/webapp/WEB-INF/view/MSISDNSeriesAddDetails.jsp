                                            ...
                                            <div class="col-md-9">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                      ...
                                                      <select id="operatorName" class="form-control">
                                                          <option selected="">Select</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="">Series Type</label>
                                                        <select id="seriesType" class="form-control">
                                                            <option selected="">Select</option>
                                                          </select>
                                                      </div>
                                                  </div>
                                                  ...
                                                  <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                      <label for="">Series Start</label>
                                                      <input type="text" class="form-control" id="seriesStart" placeholder="Enter">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                      <label for="">Series End<span class="red">*</span></label>
                                                      <input type="text" class="form-control" id="seriesEnd" placeholder="Enter">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <textarea class="form-control" rows="3" id="remarks" placeholder="Write remarks here...
                                                      "></textarea>
                                                    </div>
                                                  </div>

                                                  <div class="close-row">
                                                    <button type="submit" id="form1-submit" class="btn btn-primary save-product">Submit</button>
                                                    <button  class="btn btn-primary save-product">Cancel</button>
