    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">Approve TAC</h5>
        ...
        <div class="modal-body prl-30">
            <div class="form-row">
                <div class="form-group col-md-12 mb-4">
                    <label for="">Are you sure you want to approve ?</label>
                    <textarea class="form-control" id="approvalRemarks" rows="2" maxlength="250" placeholder="Write any remarks (if any)"></textarea>
                  </div>
            </div>

            <div class="form-row">
                <div class="form-group col-md-12 center">
                 <button type="button" class="btn btn-outline-dark center" data-dismiss="modal" onclick="approveAndRejectAction()">Yes</button>
                 <button type="button" class="btn btn-outline-danger cancel-product modal-close" onclick="ResetModel()">Cancel</button>
                  </div>
            </div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">Reject TAC</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" onclick="ResetModel()" class="cross">&times;</span>
          </button>
        </div>
        <div class="modal-body prl-30">
        <form action="#" onsubmit="return approveAndRejectAction();">
            <div class="form-row">
                <div class="form-group col-md-12 mb-4">
                    <label for="">Are you sure you want to reject ?</label>
                     <label for="">Remarks <span class="star">*</span></label>
                    <textarea class="form-control" id="rejectRemarks" rows="2" maxlength="250" placeholder="Write any remarks (if any)" required></textarea>
                  </div>
            </div>

            <div class="form-row">
                <div class="form-group col-md-12 center">
                 <button type="submit" class="btn btn-outline-dark center" data-dismiss="modal">Yes</button>
                 <button type="button" class="btn btn-outline-danger cancel-product modal-close" onclick="ResetModel()">Cancel</button>
                  </div>
            </div>
</form>
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/unapproved-device-tac.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
