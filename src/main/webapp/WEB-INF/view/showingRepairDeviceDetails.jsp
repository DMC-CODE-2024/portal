...
<c:if test="${pageContext.response.locale=='km'}">
    ...
    <h1><spring:message code="tag.pair-device.repairdevice" /></h1>
    </div>
    <div class="content-container">

    <div class="width-90 mt-35" id="repairDeviceFormDiv">

    <div class="form-content">
    <form id="repairDeviceForm">
    <div id="imeiContainer">
    <div class="form-row">
    <div class="form-group col-md-6">
    <label for="imei"><spring:message code="tag.pair-device.newMsisdn" /> <span class="star">*</span></label>
    <input type="" class="form-control" autocomplete="off"  id="imei" placeholder="<spring:message code="placeholder.pair-device.15digitimei" />"
    ...
    oninvalid="InvalidMsg(this,'input','<spring:message code="validation.imei.16digit" />');" required>
    </div>
    </div>

    <div class="form-row imei-row">
    <div class="form-group col-md-6">
    <label for="phoneNumber1"><spring:message code="tag.pair-device.oldPhoneNumber" /> <span class="star">*</span></label>
    <input type="text" autocomplete="off" class="form-control phoneNumber"  id="oldPhoneNumber" name="oldPhoneNumber" placeholder="<spring:message code="placeholder.pair-device.phonenumber" />"
    ...
    <div class="form-group col-md-6">
    <label for="phoneNumber1"><spring:message code="tag.pair-device.newPhoneNumber" /> <span class="star">*</span></label>
   ...
   <input type="text" autocomplete="off" class="form-control" id="contactNumber" style="display: none">
...
<span id="errorMsgOnModal"  class="text-danger" style="display: none" ><spring:message code="bulk.invalidCaptcha" /></span>
    ...
    <button  id="repairDeviceSubmitBtn" type="submit" class="orange-button btn" style="margin-left: 10px;"><spring:message code="tag.pair-device.submit" /></button>
    </div>
    </div>
    </div>
    </form>
    ...
    <div class="width-90 mt-20 center width-100" id="repairDeviceOTPForm" style="display:none">
    ...
    <button onclick="return submitOTPRequest(event,'repair')" class="btn orange-button"><spring:message code="tag.pair-device.verify" /></button>
    </div>
    </div>
    </div>
...
<div class="width-90 mt-20 center width-100" id="otpLimitExceedModal" style="display:none">
    ...
    <div class="col-lg-12 mt-20">
    <div class="no-border center">
    <a href="${context}/repair-device" type="button" class="btn orange-button width50-btn"><spring:message code="tag.button.cancel" /></a>
    </div>
    </div>
    </div> </div>
    ...
    <p class="mb-10"><img src="${context}/resources/assets/images/close.svg" alt="logo" class="img-fluid"></p>
    <h1><spring:message code="tag.pair-device.repairunsuccessful" /> </h1>
    <p id="rejectModalMsg"></p>
    <div class="row">
    <div class="col-lg-12 mt-20">
    <div class="no-border center">
    <a href="${context}/repair-device" type="button" class="btn orange-button width50-btn"><spring:message code="tag.repair-device.done" /></a></div>
    </div>
    </div>
    </div> </div>
    ...
    <p class="mb-10"><img src="${context}/resources/assets/images/Check1.svg" alt="logo" class="img-fluid"></p>
    <h1><spring:message code="tag.pair-device.repairSuccessful" /> </h1>
    <p id="successfullMsg"></p>
    <div class="row">
    <div class="col-lg-12 mt-20">
    <div class="no-border center">
    <a href="${context}/repair-device" type="button" class="btn orange-button width50-btn"><spring:message code="tag.repair-device.done" /></a></div>
        ...
        <script type="text/javascript"
        src="${context}/resources/project_js/repair-device.js?version=<%= (int) (Math.random() * 10) %>"></script>
        <script type="text/javascript"
