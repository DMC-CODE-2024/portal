...
<div id="viewAdminSystemModel" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title"><spring:message code="modal.IMEI-Content-Configuration" /></h5>
				</div>
				<div class="modal-content_">
						...
						<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="viewenglish_name" class=""><spring:message code="table.english_name" /></label>
								<textarea id="viewenglish_name" class="materialize-textarea form-control" Placeholder="English name" readonly="readonly" style="min-height:8rem"></textarea>

								</div>


								<div class="form-group col-md-6">
									<label for="viewkhmer_name" class=""><spring:message code="table.khmer_name" /></label>
								<textarea id="viewkhmer_name" class="materialize-textarea form-control" Placeholder="Khmer name" readonly="readonly" style="min-height:8rem"></textarea>

								</div>

								<!-- <div class="form-group col-md-6" style="margin-top: 22px;"> -->
								<div class="form-group col-md-6">
									<label for="viewlabel"><spring:message code="table.label" /></label>
									<input type="text" id="viewlabel" class="form-control" name="label" placeholder="" maxlength="20" disabled>
								</div>

								 <div class="form-group col-md-6">
									<label for="viewfeatureName"><spring:message code="table.moduleName" /> </label>
								...
								<div class="form-group col-md-6" style="margin-top: 22px;">
									<label for="viewModifiedBy" class="center-align">Created On </label>
	...
	<div id="editCheckIMEIContent" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title"><spring:message code="modal.IMEI-Content-EditConfiguration" /></h5>
				</div>
				<div class="modal-content_">
					<form action="" onsubmit="return updateSystem()">
						...
						<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="editValue" class=""><spring:message code="table.english_name" /> <span class="star">*</span></label>
								<textarea id="editenglish_name" class="materialize-textarea form-control" Placeholder=""  maxlength="100"
								...
								<div class="form-group col-md-6">
									<label for="editkhmer_name" class=""><spring:message code="table.khmer_name" /></label>
								<textarea id="editkhmer_name" class="materialize-textarea form-control" Placeholder="" placeholder="" title="Please enter alphabets and numbers upto 200 characters only" maxlength="200" style="min-height:8rem"></textarea>
				
								</div>
				
								<!-- <div class="form-group col-md-6" style="margin-top: 22px;"> -->
								<div class="form-group col-md-6">
									<label for="type"><spring:message code="table.label" /></label>
									<input type="text" id="editlabel" class="form-control" name="label" placeholder="" maxlength="20" disabled>
								</div>
								...
								<div class="form-group col-md-6" style="margin-top: 22px;">
									<label for="editModifiedBy" class="center-align">Created On </label>
	...
	<div id="confirmedUpdatedSystem" class="modal" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-lg" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title"><spring:message code="modal.IMEI-Content-UpdateSystem" /></h5>
				</div>
				<div class="modal-body">
				  <p id="updateFieldMessage"></p>
				</div>
				<div class="modal-footer">
					<a href="${context}/checkIMEIContent" class="cancel-product btn modal-close"><spring:message code="modal.ok" /></a>
				</div>
			  </div>
			</div>
		  </div>
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/viewCheckIMEIContent.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
