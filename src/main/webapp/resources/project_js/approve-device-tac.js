...
function table(){
	...
	$.ajaxSetup({
		...
		{ 'X-CSRF-TOKEN': token }
				...
				$.ajax({
    				url: '../headers?type=trc&requestType=APPROVED',
    				type: 'POST',
    				dataType: "json",
...
return new Promise((resolve, reject) => {
	...
	$.ajax({
		url: '../approve-device-tac/page-rendering?type=approved&FeatureId='+featureId,
		type: 'POST',
		dataType: "json",
		success: function(data){
			...
			var nextPageLink = '<a href="../approveTac?FeatureId=' + featureId + '" target="mainArea"><button type="button"  id="btnLink"  class="btn btn-outline-dark"></button></a>';
