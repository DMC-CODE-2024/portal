...
//var elem='<h1>'+data.pageTitle+'<h1>';
			var elem='<h1>Local Manufacturer IMEI<h1>';
		    $("#pageHeaderTitle").append(elem);
		    $("#pageHeader").append("<button type='button' id='uploadTABtn' class='btn btn-outline-dark mr-2' onclick='uploadTAData()'> + Upload IMEI </button>");
       		        		  let html = "./viewlocalManufacturerIMEI?FeatureId="+featureId;
                                                $("#pageHeader").append('<a href='+html+' target="mainArea"><button type="button"  id="btnLink"  class="btn btn-outline-dark">View IMEI</button></a>');
       		...
       		var button=data.buttonList;
				...
				//$("#filterButtonDiv").append("<div><button type='button' class='btn btn-outline-dark' id='submitFilter'> <span><img src='./resources/assets/images/filter-icon.svg' alt='icon' class='img-fluid ml-1'></span>" + $.i18n('applyFilter') + "</button></div>");
				...
				$("#filterButtonDiv").append("<div class='form-group'><button type='button' class='btn btn-outline-dark' onclick='TrcDataTable()'>Apply Filter <img src='./resources/assets/images/filter-icon.svg' alt='icon' class='img-fluid ml-1'></button>");
				$("#filterButtonDiv").append("<div class='form-group'><button type='button' class='btn btn-outline-dark' onclick='exportData()'>"+$.i18n('Export')+" <img src='./resources/assets/images/download-icon.svg' alt='icon' class='img-fluid ml-1'></button>");
...
/*
function fileDownload(fileName,transactionID){
...
fileName=fileName.split("%20").join(" ");
	...
	$.ajax({
		//url : "./Consignment/dowloadFiles/"+fileName+'/'+transactionID,
		url : './Download-File?fileName='+fileName+'&transactionID='+transactionID,
		dataType : 'json',
		contentType : 'application/json; charset=utf-8',
		type : 'GET',
		success : function(data) {
...
function uploadFile(){
	...
	formData.append('requestType', 'LM');
