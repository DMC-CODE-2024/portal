...
function VIPLISTDatatable(){
	...
	$.ajax({
		url: 'headers?type=greyListHeaders',
		type: 'POST',
		dataType: "json",
...
function pageRendering(){
	...
	$.ajax({
		...
		success: function(data){
			...
			/*$('#vipListTableDiv div:last').after("<p id='errorMsg' style='padding:4px;color: red;font-size: 15px;position: absolute;left: 23px;margin: 0;top: 57px;' class='left'></p>")	*/
