	...
	return new Promise((resolve, reject) => {
		...
		$.ajax({
			...
			success: function(data) {
					var elem = '<h1>Qualified Agent<h1>';
					$("#pageHeaderTitle").append(elem);
					    $("#pageHeader").append("<button type='button' id='uploadTABtn' class='btn btn-outline-dark mr-2' onclick='uploadTAData()'> + QA Upload </button>")
                           		  let html = "./viewQualifiedAgent?FeatureId="+featureId;
                                    $("#pageHeader").append('<a href='+html+' target="mainArea"><button type="button"  id="btnLink"  class="btn btn-outline-dark">View QA Data</button></a>');
