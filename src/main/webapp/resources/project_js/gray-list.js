    ...
    //     $("#pageHeader").append('<a href="./eirs-list-management?FeatureId=86" target="mainArea"><button type="button"  id="btnLink"  class="btn btn-outline-dark">Exception List</button></a>');
    ...
    $.getJSON('./getDropdownList/GRAY_LIST_CATEGORY_TYPE', function(data) {
