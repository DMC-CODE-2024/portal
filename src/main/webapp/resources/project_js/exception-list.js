...
function table(){
	...
	$.ajaxSetup({
		...
		{ 'X-CSRF-TOKEN': token }
				...
				$.ajax({
    				url: './headers?type=exceptionList',
    				type: 'POST',
    				dataType: "json",
...
return new Promise((resolve, reject) => {
	...
	$.ajax({
		url: './exception-list/page-rendering',
		type: 'POST',
		dataType: "json",
		success: function(data){
           ...
           $("#pageHeader").append('<a href="./eirs-list-management?FeatureId=' + featureId + '" target="mainArea"><button type="button"  id="btnLink"  class="btn btn-outline-dark">Back</button></a>');
...
$.getJSON('./getDropdownList/EXCEPTION_LIST_CATEGORY_TYPE', function(data) {
